...
class FadingEdgeLayout : FrameLayout {
    ...
    private var fadeTop: Boolean = false
    private var fadeBottom: Boolean = false
    private var fadeLeft: Boolean = false
    private var fadeRight: Boolean = false
    private var gradientSizeTop: Int = 0
    private var gradientSizeBottom: Int = 0
    private var gradientSizeLeft: Int = 0
    private var gradientSizeRight: Int = 0
    ...
    private var gradientDirtyFlags: Int = 0
    ...
    private fun init(attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        if (attrs != null) {
            ...
            val flags = arr.getInt(R.styleable.FadingEdgeLayout_fading_edge, 0)
            ...
            gradientSizeTop = arr.getDimensionPixelSize(R.styleable.FadingEdgeLayout_fading_top, defaultSize)
            gradientSizeBottom = arr.getDimensionPixelSize(R.styleable.FadingEdgeLayout_fading_bottom, defaultSize)
            gradientSizeLeft = arr.getDimensionPixelSize(R.styleable.FadingEdgeLayout_fading_left, defaultSize)
            gradientSizeRight = arr.getDimensionPixelSize(R.styleable.FadingEdgeLayout_fading_right, defaultSize)
    ...
    private fun initTopGradient() {
        ...
        val gradient =
            LinearGradient(l.toFloat(), t.toFloat(), l.toFloat(), b.toFloat(), FADE_COLORS, null, Shader.TileMode.CLAMP)
    ...
    private fun initLeftGradient() {
        ...
        val gradient =
            LinearGradient(l.toFloat(), t.toFloat(), r.toFloat(), t.toFloat(), FADE_COLORS, null, Shader.TileMode.CLAMP)
